...
namespace SpatialPartitionPattern
{
    public class GameController : MonoBehaviour
    {
        ...
        public int numberOfSoldiers = 500;

        //The Spatial Partition grid
        Grid grid;

        //Bool for the change between slow and fast update
        public Toggle CheckMarkInUI;
        ...
        void Start()
        {
            ...
            for (int i = 0; i < numberOfSoldiers; i++)
            {
                ...
                Vector3 randomPos = new Vector3(Random.Range(0f, mapWidth), Random.Range(0f, 20f), Random.Range(0f, mapWidth));
                ...
                randomPos = new Vector3(Random.Range(0f, mapWidth), Random.Range(0f, 20f), Random.Range(0f, mapWidth));
        ...
        void Update()
        {
            ...
            void FindFastEnemy(int i)
            {
                ...
                UpdateTextCounter(endTime);

            }

            void FindSlowEnemy(int i)
            {
            ...
            void UpdateTextCounter(float endTime)
            {


                UpdateText.text = "Update: " + ((startTime - endTime) * -1000f) + " ms";
            }
        }
    }
}
