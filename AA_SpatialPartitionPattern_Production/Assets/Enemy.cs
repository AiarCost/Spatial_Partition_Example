...
namespace SpatialPartitionPattern
{
    ...
    public class Enemy : Soldier
    {
        ...
        public Enemy(GameObject soldierObj, float mapWidth, Grid grid)
        {
            ...
            this.soldierMeshRenderer = soldierObj.GetComponentInChildren<MeshRenderer>();
        ...
        void GetNewTarget()
        {
            currentTarget = new Vector3(Random.Range(0f, mapWidth), Random.Range(0f, 20f), Random.Range(0f, mapWidth));
